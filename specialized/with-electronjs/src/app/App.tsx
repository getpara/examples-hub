...
export default function App() {
  const [message, setMessage] = useState("Hello Para from Electron!");
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4">Para Electron Demo</h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Sign messages with your Para wallet in an Electron desktop application. This example demonstrates Para SDK
          integration with Electron using Vite and TypeScript.
        </p>
      </div>
