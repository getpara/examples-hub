...
This example demonstrates how to integrate Para SDK with ZeroDev's account abstraction infrastructure to create and manage ERC-4337 smart wallets in a Next.js application. It showcases gasless transactions, multi-wallet management, and seamless user onboarding through Para's authentication.
...
- `@zerodev/sdk` (v5.3.18) - ZeroDev Account Abstraction SDK
- `@zerodev/ecdsa-validator` (v5.3.13) - ECDSA validator for ZeroDev
...
- `src/config/zerodev.ts` - ZeroDev configuration and constants
- `src/lib/create-zerodev-client.ts` - ZeroDev client creation with Para integration
