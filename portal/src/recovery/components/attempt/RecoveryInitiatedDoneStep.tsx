...
import WalletSuccess from '../../../library/modal/assets/walletSuccess'
    ...
    return (
        <VStack flex={1}>
            ...
            <Text
                ...
                align="center"
            >
                You will now need to wait for <Text as='b'>48 hours</Text> until your wallet 
                can be recovered.
            </Text>
            <Text 
                fontSize='md'
                ...
                paddingTop="4"
            >
                You can come back to this page and check the status at any 
                point, or cancel this Recovery Attempt by visiting your email.
            </Text>
            <Spacer />
            <Button
                width="100%"
