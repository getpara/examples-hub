  ...
  return (
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 32 32" fill="none">
        <path d="M27 12.5V5H19.5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M18 14L27 5" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
