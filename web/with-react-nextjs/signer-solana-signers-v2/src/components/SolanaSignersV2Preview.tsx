...
const routeContent = {
  "message-signing": {
    ...
    description:
      "Sign arbitrary text with Para's Solana Signers v2 signer, then verify the signature with the connected public key.",
    fields: [{ label: "Message to Sign", placeholder: "Hello from Para + Signers v2!", as: "textarea" as const }],
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3">
        <div className="flex min-w-0 items-center gap-4">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-muted-foreground">Solana Signers v2</span>
          </Link>
...
export function SolanaSignersV2Preview({ variant }: { variant: PreviewVariant }) {
  return (
    ...
    <div className="mx-auto w-full max-w-6xl px-5 py-10">
      <div className="mx-auto mb-10 max-w-3xl text-center animate-fade-in-up">
        ...
        <p className="text-[13px] font-mono leading-relaxed text-muted-foreground">
          Explore Solana message signing and SOL transfers with Para's Signers v2 integration.
        </p>
      </div>
