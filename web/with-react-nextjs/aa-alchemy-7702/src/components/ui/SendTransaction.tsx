  ...
  return (
    <div className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden animate-fade-in-up-delayed">
      <div className="px-6 py-4 border-b border-border/60">
        <h2 className="text-sm font-semibold">Send EIP-7702 Transaction</h2>
      </div>

      <div className="p-6 space-y-4">
        {isPending && (
          <div className="rounded-xl bg-muted/60 border border-border/60 px-4 py-3 animate-fade-in">
            <p className="text-sm text-muted-foreground">Sending gas-sponsored EIP-7702 transaction...</p>
          </div>
        )}
        ...
        {transactionHash && !error && (
          <div className="rounded-xl bg-success/8 border border-success/15 px-4 py-3 animate-fade-in">
            <p className="text-sm text-success-foreground">Sponsored EIP-7702 transaction sent.</p>
          </div>
        )}
        ...
        <p className="text-[13px] font-mono text-muted-foreground leading-relaxed">
          Sends a zero-value transaction using Alchemy Account Kit in EIP-7702 mode with paymaster gas sponsorship.
        </p>
