...
export default function MessageSigningPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!signer || !anchorProvider) return;
  ...
  // Verify signature using tweetnacl (works on all browsers)
  const handleVerify = async () => {
    try {
      if (!message || !signature || !anchorProvider) return;
    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <code className="font-mono text-sm bg-gray-50 text-gray-700 px-2 py-1 rounded-none">signMessage()</code>
