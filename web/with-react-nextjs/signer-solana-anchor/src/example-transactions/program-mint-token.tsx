        ...
        try {
          ...
          try {
            try {
              ...
              const uiAmount =
                Number(accountInfo.amount) / Math.pow(10, decimals);
    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          This demo shows how to mint tokens using the transfer_tokens program
          deployed at address {PROGRAM_ID.toString()}.
        </p>
      </div>
        ...
        <form onSubmit={handleMintToken} className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-500">
              Note: The amount will be adjusted for decimals (9 decimals) in the
              contract
            </p>
          </div>
          ...
          <button
            ...
            disabled={
              !mintAccount || !recipient || !amount || isLoading || !isConnected
            }
          >
