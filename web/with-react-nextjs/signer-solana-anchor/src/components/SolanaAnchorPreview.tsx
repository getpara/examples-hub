...
type PreviewVariant = "selector" | "message-signing" | "sol-transfer" | "program-create-token" | "program-mint-token";

const demoCards = [
  {
    title: "Message Signing",
    description: "Sign a message with your Para Solana account and verify the signature against the wallet public key.",
    path: "/message-signing",
  },
  {
    title: "SOL Transfer",
    description: "Send SOL on Devnet through an Anchor provider backed by Para's Solana web3.js signer.",
    path: "/sol-transfer",
  },
  {
    title: "Program Create Token",
    description: "Call the sample Anchor program to create a token mint using Token-2022 accounts.",
    path: "/program-create-token",
  },
  {
    title: "Program Mint Token",
    description: "Interact with the deployed Anchor program to mint tokens to a Solana recipient account.",
...
const routeContent = {
  "message-signing": {
    ...
    description: "Sign an arbitrary message with Para's Solana web3.js signer, then verify it with the wallet key.",
    fields: [{ label: "Message to Sign", placeholder: "Hello from Para + Anchor!", as: "textarea" as const }],
    button: "Connect Wallet",
  },
  "sol-transfer": {
    title: "SOL Transfer Demo",
    description: "Send SOL on Devnet with an Anchor provider that uses Para's Solana web3.js signer.",
    fields: [
  ...
  "program-create-token": {
    title: "Create Token Demo",
    description: "Create a Token-2022 mint by calling the sample Anchor program with a Para-backed provider.",
    fields: [
      { label: "Token Name", placeholder: "My Token", as: "input" as const },
      { label: "Token Symbol", placeholder: "MTK", as: "input" as const },
    ],
    button: "Connect Wallet",
  },
  "program-mint-token": {
    title: "Mint Token Demo",
    description: "Mint tokens from an existing Token-2022 mint by calling the deployed Anchor program.",
    fields: [
      { label: "Mint Account Address", placeholder: "Token mint address", as: "input" as const },
      { label: "Recipient Address", placeholder: "Recipient Solana address", as: "input" as const },
      { label: "Amount to Mint", placeholder: "0", as: "input" as const },
    ],
    button: "Connect Wallet",
  },
};
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3">
        <div className="flex min-w-0 items-center gap-4">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-muted-foreground">Solana Anchor Signer</span>
          </Link>
...
export function SolanaAnchorPreview({ variant }: { variant: PreviewVariant }) {
  return (
    ...
    <div className="mx-auto w-full max-w-6xl px-5 py-10">
      <div className="mx-auto mb-10 max-w-3xl text-center animate-fade-in-up">
        ...
        <p className="text-[13px] font-mono leading-relaxed text-muted-foreground">
          Explore signing Solana messages, transfers, and Anchor program calls with Para.
        </p>
      </div>
