...
export default function MessageSigningDemo() {
  ...
  const { signMessage, verifySignature, signature, isVerified, isLoading, isReady, error, reset } =
    useMessageSigning();
    ...
    <div className="mx-auto w-full max-w-6xl px-5 py-10">
      <div className="mb-8 text-center animate-fade-in-up">
        ...
        <p className="mx-auto max-w-2xl text-[13px] font-mono leading-relaxed text-muted-foreground">
          Sign an arbitrary message with Para's Solana web3.js signer, then verify the signature with the connected
          Solana public key.
        </p>
      </div>
