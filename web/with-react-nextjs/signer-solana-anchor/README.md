...
This example demonstrates how to use the Para SDK with the Anchor framework for signing messages and transactions. It
provides multiple example transaction types using the Para Anchor signer. Authentication is handled through the
ParaModal. Anchor requires using the para solana-web3.js signer implementation.
