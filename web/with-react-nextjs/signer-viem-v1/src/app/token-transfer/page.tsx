    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Transfer ERC20 tokens between addresses. This demo uses the ParaTestToken (PTT) contract deployed on Holesky
          testnet.
        </p>
      </div>
        ...
        <div className="mb-8 rounded-none border border-gray-200">
          ...
          <div className="px-6 py-3 space-y-2">
            ...
            <div className="flex justify-between">
              <span className="text-sm text-gray-700">ETH Balance:</span>
            ...
            <div className="flex justify-between">
              <span className="text-sm text-gray-700">{tokenSymbol} Balance:</span>
              <span className="text-sm font-medium text-gray-900">
                {!address
                  ? "Connect wallet"
                  : isBalanceLoading
