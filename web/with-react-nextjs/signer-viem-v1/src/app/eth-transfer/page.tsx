...
export default function EthTransferPage() {
  ...
  const validateTransaction = async (ethAmount: string): Promise<boolean> => {
    if (!address || !publicClient) {
      throw new Error("No sender address or publicClient available");
    }
    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Send ETH with your connected wallet. This demonstrates a basic ETH transfer using the Para SDK with viem
          integration.
        </p>
      </div>
