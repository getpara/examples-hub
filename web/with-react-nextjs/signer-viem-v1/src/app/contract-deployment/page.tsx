    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Deploy an ERC20 token contract using the Para SDK with viem integration. This demo uses the{" "}
          <code className="font-mono text-sm bg-gray-50 text-gray-700 px-2 py-1 rounded-md">ParaTestToken</code>{" "}
      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="mb-8 rounded-none border border-gray-200 bg-gray-50">
          <div className="px-6 py-4">
            <h3 className="text-lg font-medium text-gray-900 mb-3">Contract Details</h3>
            <div className="space-y-2 text-sm">
              <div>
                <span className="text-gray-600">Contract Name:</span>{" "}
                <span className="font-medium">ParaTestToken</span>
              </div>
              <div>
                <span className="text-gray-600">Symbol:</span> <span className="font-medium">PTT</span>
              </div>
              <div>
                <span className="text-gray-600">Total Supply:</span>{" "}
                <span className="font-medium">1,000,000 PTT</span>
              </div>
              <div>
                <span className="text-gray-600">Features:</span>{" "}
                <span className="font-medium">ERC20, Burnable, Capped, Permit</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="rounded-none border border-gray-200">
              ...
              <div className="p-6">
                ...
                <a
                  ...
                  className="mt-3 inline-block px-3 py-1 text-sm bg-gray-900 text-white hover:bg-gray-950 transition-colors rounded-none">
                  View on Etherscan
                </a>
              </div>
            </div>
