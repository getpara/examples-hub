# Para Signing with Viem v1 Example

This example demonstrates how to use the Para SDK with Viem v1 for signing messages and transactions. It provides
multiple example transaction types using the Para Viem v1 signer. Authentication is handled through the ParaModal before
being able to sign.
