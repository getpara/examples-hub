    ...
    <>
      ...
      <div className="bg-white rounded-none border border-gray-200 p-6 mb-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-medium">Sign Message (ADR-036)</h3>
          <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">Cosmos Amino</span>
        </div>
      ...
      {signature && (
        <div className="bg-white rounded-none border border-gray-200 p-6">
          <h3 className="text-lg font-medium mb-2">ADR-036 Signature</h3>
