  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4">Para Modal + Cosmos Demo</h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Sign messages with your Para wallet connected through Cosmos wallets (Keplr/Leap). This example demonstrates
          integration with the Cosmos ecosystem using Para&apos;s built-in modal and React SDK hooks.
        </p>
      </div>
