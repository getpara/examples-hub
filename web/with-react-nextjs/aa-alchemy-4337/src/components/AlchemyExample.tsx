...
import { useAlchemySponsoredTransaction } from "@/hooks/useAlchemySponsoredTransaction";
import { CHAIN } from "@/lib/alchemy";

export function AlchemyExample() {
  return (
    <ParaProvider>
      <AlchemyExampleContent />
    </ParaProvider>
  );
}

function AlchemyExampleContent() {
  ...
  } = useAlchemySponsoredTransaction({ enabled: isConnected });
