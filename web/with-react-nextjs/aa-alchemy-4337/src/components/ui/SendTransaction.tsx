      ...
      <div className="p-6 space-y-4">
        {isPending && (
          <div className="rounded-xl bg-muted/60 border border-border/60 px-4 py-3 animate-fade-in">
            <p className="text-sm text-muted-foreground">Sending gas-sponsored UserOperation...</p>
          </div>
        )}
        ...
        {transactionHash && !error && (
          <div className="rounded-xl bg-success/8 border border-success/15 px-4 py-3 animate-fade-in">
            <p className="text-sm text-success-foreground">Sponsored transaction sent.</p>
          </div>
        )}
        ...
        <p className="text-[13px] font-mono text-muted-foreground leading-relaxed">
          Sends a zero-value transaction through Alchemy Account Kit with paymaster gas sponsorship.
        </p>
