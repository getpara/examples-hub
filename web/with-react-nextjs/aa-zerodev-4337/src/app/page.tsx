  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4">ZeroDev Account Abstraction</h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Send gas-sponsored transactions using Para wallet with ZeroDev&apos;s EIP-4337 infrastructure. This example
          demonstrates Kernel smart accounts with paymaster gas sponsorship on Sepolia testnet.
        </p>
      </div>
