...
export default function SolTransferDemo() {
  ...
  const { transfer, txSignature, isLoading, error, isReady, status, reset } = useSolTransfer();
    ...
    <div className="mx-auto w-full max-w-6xl px-5 py-10">
      <div className="mb-8 text-center animate-fade-in-up">
        ...
        <p className="mx-auto max-w-2xl text-[13px] font-mono leading-relaxed text-muted-foreground">
          Send SOL on Devnet with a transaction signed by Para's Solana web3.js integration.
        </p>
      </div>
