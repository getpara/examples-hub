  ...
  return (
    <div className="space-y-4">
      ...
      <StepCard
        ...
        description="Requests Sepolia ETH for the Para guardian wallet. Cooldown or rate-limit errors stay visible in the flow.">
      ...
      <StepCard
        ...
        description="The host starts recovery with the custom-authenticated Para guardian signer. The guardian signature only completes after Para user authentication and Para co-signing. The owner can veto during the delay.">
