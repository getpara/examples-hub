    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          integration via the{" "}
          <code className="font-mono text-sm bg-gray-100 text-gray-700 px-2 py-1 rounded-md">ethersParaSigner</code>{" "}
          provider.
        </p>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div className="flex-1">
                <p className="text-sm text-gray-600">Network: Holesky</p>
            ...
            <Card title="Transaction Hash">
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="inline-block px-3 py-1 text-sm bg-gray-900 text-white hover:bg-gray-950 transition-colors rounded-none">
                  View on Etherscan
                </a>
              </div>
            </Card>
