...
import { useGelato7702SponsoredTransaction } from "@/hooks/useGelato7702SponsoredTransaction";
import { CHAIN } from "@/lib/gelato";

export function Gelato7702Example() {
  return (
    <ParaProvider>
      <Gelato7702ExampleContent />
    </ParaProvider>
  );
}

function Gelato7702ExampleContent() {
  ...
  } = useGelato7702SponsoredTransaction({ enabled: isConnected });
