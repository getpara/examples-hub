    ...
    <div className="flex-1 flex flex-col items-center justify-center p-4 z-0">
      <div className="container mx-auto max-w-2xl flex flex-col items-center text-center space-y-6 py-8 md:py-10">
        ...
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl text-foreground">
          Smart Wallets with Thirdweb
        </h1>
        <p className="max-w-[600px] text-muted-foreground md:text-lg">
          Experience the power of ERC-4337 Account Abstraction with Thirdweb's smart accounts. Create gasless, 
          programmable wallets on Sepolia testnet.
        </p>
        <div className="space-y-4 pt-4 w-full max-w-lg">
          <h2 className="text-2xl font-semibold tracking-tight">Thirdweb Features</h2>
          <ul className="grid gap-3 text-left text-sm md:text-base">
            <li className="flex items-start">
              ...
              <span>
                <strong>Smart Accounts:</strong> ERC-4337 compliant accounts with flexible validation and modular architecture.
              </span>
            </li>
            <li className="flex items-start">
              <CheckCircle2 className="mr-2 mt-0.5 h-4 w-4 flex-shrink-0 text-primary" />
              <span>
                <strong>Gas Sponsorship:</strong> Gasless transactions powered by Thirdweb's paymaster infrastructure.
              </span>
            </li>
            <li className="flex items-start">
              <CheckCircle2 className="mr-2 mt-0.5 h-4 w-4 flex-shrink-0 text-primary" />
              <span>
                <strong>Bundler Infrastructure:</strong> Reliable UserOperation bundling with Thirdweb's production-grade bundler.
              </span>
            </li>
            <li className="flex items-start">
              <CheckCircle2 className="mr-2 mt-0.5 h-4 w-4 flex-shrink-0 text-primary" />
        ...
        <div className="bg-muted/50 rounded-lg p-4 text-sm text-muted-foreground max-w-lg">
          ...
          <p>This demo runs on Sepolia testnet with sponsored gas. Connect your wallet to create and manage Thirdweb-powered smart accounts.</p>
        </div>
        <div className="pt-6">
          <ConnectWalletButton
