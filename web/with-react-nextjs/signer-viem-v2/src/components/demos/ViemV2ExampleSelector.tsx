...
export default function ViemV2ExampleSelector() {
  const wallet = useEvmWalletConnection();

  return (
    <main className="mx-auto w-full max-w-6xl px-5 py-10">
      <div className="mx-auto mb-10 max-w-3xl text-center animate-fade-in-up">
        <h1 className="mb-3 text-3xl font-semibold tracking-tight text-card-foreground">Para Viem v2 Signer</h1>
        <p className="text-[13px] font-mono leading-relaxed text-muted-foreground">
          ...
          file to see how we request a Para-backed Viem wallet client and account.
        </p>
      </div>
