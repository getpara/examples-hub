    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Sign a message with your connected wallet. This demonstrates the{" "}
          <code className="font-mono text-sm bg-gray-50 text-gray-700 px-2 py-1 rounded-none">signBytes()</code> method
          of the ParaStellarSigner. You can also verify the Ed25519 signature to ensure its authenticity.
        </p>
      </div>
