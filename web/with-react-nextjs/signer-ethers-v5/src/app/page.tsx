  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4">Para + Ethers v5 Demo</h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Explore signing different transaction types using Para with Ethers.js v5. Reference the
          <code className="font-mono text-sm bg-gray-100 text-gray-700 px-2 py-1 rounded-none mx-1">
            /src/hooks/useParaSigner.ts
          </code>
          file to see how we integrate Para with ethers v5.
        </p>
      </div>
