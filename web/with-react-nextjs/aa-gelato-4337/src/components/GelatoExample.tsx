...
import { useGelatoSponsoredTransaction } from "@/hooks/useGelatoSponsoredTransaction";
import { CHAIN } from "@/lib/gelato";

export function GelatoExample() {
  return (
    <ParaProvider>
      <GelatoExampleContent />
    </ParaProvider>
  );
}

function GelatoExampleContent() {
  ...
  } = useGelatoSponsoredTransaction({ enabled: isConnected });
