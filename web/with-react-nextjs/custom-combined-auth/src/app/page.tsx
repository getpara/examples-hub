  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4">Custom Combined Auth Demo</h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Sign messages with your Para wallet using multiple authentication methods. This demonstrates building your
          own auth UI with Para SDK hooks combining email, phone, and OAuth login options.
        </p>
      </div>
