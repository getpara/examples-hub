...
interface ExecuteBody {
  partyId?: string;
  // Full PrepareSubmissionResponse echoed back from /preapproval/prepare.
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // executeSubmission attaches the signature to the partySignatures bundle
    // keyed by getPartyId(); rehydrate the controller for this request.
