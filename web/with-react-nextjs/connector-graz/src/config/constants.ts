import { Environment } from "@getpara/graz-integration";
...
export const PROVIDER_TESTNET_RPC =
  process.env.NEXT_PUBLIC_PROVIDER_TESTNET_RPC || "https://rpc-rs.cosmos.nodestake.top";
