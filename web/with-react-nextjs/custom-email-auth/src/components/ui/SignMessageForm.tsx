...
export function SignMessageForm({
  ...
  return (
    <form onSubmit={onSubmit} className="bg-white rounded-none border border-gray-200 p-6 mb-4">
      ...
      <div className="space-y-4">
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-3 py-2 border border-gray-300 rounded-none focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent resize-none"
            disabled={isLoading}
          />
        </div>
        <button
