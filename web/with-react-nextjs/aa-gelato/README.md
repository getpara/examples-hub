...
This example demonstrates how to integrate Para SDK with Gelato's account abstraction infrastructure to create and manage ERC-4337 smart wallets in a Next.js application. It showcases gasless transactions, multi-wallet management, and seamless user onboarding through Para's authentication.
...
- `@gelatonetwork/smartwallet` (v1.5.0) - Gelato Smart Wallet SDK
...
- `src/config/gelato.ts` - Gelato configuration and constants
- `src/lib/create-gelato-client.ts` - Gelato client creation with Para integration
...
- [Gelato Documentation](https://docs.gelato.network/web3-services/relay)
