            ...
            <CardTitle className="text-2xl flex items-center justify-center gap-2">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="max-w-xs">Each EOA can create up to 3 smart wallets for security and management purposes</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </CardTitle>
            <CardDescription>
              You have reached the maximum of 3 smart wallets. To create a new one,
