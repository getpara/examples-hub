                ...
                <TooltipContent>
                  ...
                  {nextAvailableIndex === null && (
                    <div className="space-y-1">
                      <p>Wallet limit reached (3 max)</p>
                      <p className="text-xs text-muted-foreground">Each EOA can create up to 3 smart wallets for security and management purposes</p>
                    </div>
                  )}
                  {nextAvailableIndex === undefined &&
                    !isWalletsLoading &&
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <div className="space-y-1">
                          <p>
                            Create wallet {nextAvailableIndex + 1} of 3
                          </p>
                          <p className="text-xs text-muted-foreground">Each EOA can create up to 3 smart wallets for security and management purposes</p>
                        </div>
                      </TooltipContent>
                    ...
                    {nextAvailableIndex === null || nextAvailableIndex === undefined ? (
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {isWalletsError ? "Error loading wallet information" : "Each EOA can create up to 3 smart wallets for security and management purposes"}
                        </p>
                      </div>
                    ) : (
                      <div className="space-y-1">
