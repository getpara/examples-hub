...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        appendParaPrefix('group/navigation-menu relative flex max-w-max flex-1 items-center justify-center'),
        className,
      )}
      {...props}
    >
...
function NavigationMenuList({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.List>) {
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(appendParaPrefix('group flex flex-1 list-none items-center justify-center gap-1'), className)}
      {...props}
    />
  );
}
...
function NavigationMenuItem({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Item>) {
  return (
    <NavigationMenuPrimitive.Item
      ...
      className={cn(appendParaPrefix('relative'), className)}
      {...props}
    />
  );
}
...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(navigationMenuTriggerStyle(), appendParaPrefix('group'), className)}
      {...props}
    >
      {children}{' '}
      <ChevronDownIcon
...
function NavigationMenuViewport({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Viewport>) {
  return (
    <div className={cn(appendParaPrefix('absolute top-full left-0 isolate z-50 flex justify-center'))}>
...
function NavigationMenuIndicator({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Indicator>) {
  return (
    <NavigationMenuPrimitive.Indicator
      ...
      {...props}
    >
      <div className={appendParaPrefix('bg-border relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm shadow-md')} />
    </NavigationMenuPrimitive.Indicator>
  );
}
