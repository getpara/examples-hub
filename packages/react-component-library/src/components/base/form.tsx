...
function FormMessage({ className, ...props }: React.ComponentProps<'p'>) {
  ...
  return (
    <p
      ...
      id={formMessageId}
      className={(cn('para:text-sm', error ? 'text-destructive' : ''), className)}
      {...props}
    >
      {body}
    </p>
...
export { useFormField, Form, FormItem, FormLabel, FormControl, FormDescription, FormMessage, FormField, useFormContext };
