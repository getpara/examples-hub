...
export const LOCAL_STORAGE_ENCLAVE_JWT = `${PREFIX}enclaveJwt`;
export const LOCAL_STORAGE_ENCLAVE_REFRESH_JWT = `${PREFIX}enclaveRefreshJwt`;
export const LOCAL_STORAGE_AUTH_METHOD = `${PREFIX}authMethod`;
...
export const EXTERNAL_WALLET_CONNECTION_ONLY_USER_ID = 'EXTERNAL_WALLET_CONNECTION_ONLY';

export const ACCOUNT_LINK_CONFLICT = 'Account already linked';
