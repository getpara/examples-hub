...
type UseWaitForAccountCreationReturnType<TData = boolean, TError = Error, TVariables = void, TContext = unknown> = Compute<
...
export const useWaitForAccountCreation = () => {
  ...
  const mutation = useMutation({
    mutationFn: async () => await waitForAccountCreation(client),
    onSettled: async () => {
  ...
  return renameMutations<UseWaitForAccountCreationReturnType, boolean, Error, void, unknown>(
    mutation,
