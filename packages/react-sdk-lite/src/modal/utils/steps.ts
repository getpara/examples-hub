// Import from core-sdk types to avoid re-export mismatch in web-sdk index
...
export const RESET_TO_ACCOUNT_STEPS = [
  ...
  ModalStep.ACCOUNT_SEND,
  ModalStep.ACCOUNT_SEND_ASSET,
  ModalStep.ACCOUNT_SEND_NETWORK,
  ModalStep.ACCOUNT_WALLET,
...
export const AccountPreviousStep: {
  ...
  [AccountStep.ACCOUNT_WALLET]: ModalStep.ACCOUNT_PROFILE,
  ...
  [AccountStep.ACCOUNT_SEND]: ModalStep.ACCOUNT_MAIN,
  [AccountStep.ACCOUNT_SEND_ASSET]: ModalStep.ACCOUNT_SEND,
  [AccountStep.ACCOUNT_SEND_NETWORK]: ModalStep.ACCOUNT_SEND_ASSET,
};
