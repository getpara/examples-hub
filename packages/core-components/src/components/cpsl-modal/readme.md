...
| `footerExpanded`           | `footer-expanded`            | Whether or not to show `footerExpandedFooter` and `footerExpandedHeader` slots.                         | `boolean` | `undefined` |
| `footerTransitionDuration` | `footer-transition-duration` | Duration in seconds of the footer expansion animation. Default is 0.15.                                 | `number`  | `0.15`      |
...
graph TD;
  ...
  style cpsl-modal fill:#f9f,stroke:#333,stroke-width:4px
```
