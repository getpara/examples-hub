...
async function installWebDependencies(): Promise<void> {
  const startTime = Date.now();
  console.log('🚀 Installing dependencies in web projects');
  console.log('============================================================');
  ...
  console.log('\n============================================================');
  console.log('📊 Installation Summary (Web):');
  ...
  if (failed > 0) {
    ...
    console.log('🎉 All web installations completed successfully!');
  }
}

if (process.argv.includes('--help') || process.argv.includes('-h')) {
  console.log('Usage: tsx install-web.ts');
  console.log('');
  console.log('Installs dependencies in all web projects');
  process.exit(0);
}

installWebDependencies().catch(error => {
