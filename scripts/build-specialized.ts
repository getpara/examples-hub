...
async function buildSpecializedProjects(): Promise<void> {
  const startTime = Date.now();
  console.log('🔨 Building specialized projects');
  console.log('============================================================');
  ...
  console.log('\n============================================================');
  console.log('📊 Build Summary (Specialized):');
  ...
  if (failed > 0) {
    ...
    console.log('🎉 All specialized builds completed successfully!');
  }
}

if (process.argv.includes('--help') || process.argv.includes('-h')) {
  console.log('Usage: tsx build-specialized.ts');
  console.log('');
  console.log('Builds all specialized projects that have build scripts');
  console.log('Automatically cleans build artifacts after successful builds');
  process.exit(0);
}

buildSpecializedProjects().catch(error => {
