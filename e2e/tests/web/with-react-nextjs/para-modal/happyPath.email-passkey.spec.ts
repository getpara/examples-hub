...
test.describe('Para Modal - Email + Passkey Authentication', () => {
  test('happy path - create and login with email and passkey', async ({ browser }) => {
    console.log('🚀 Starting React Next.js Para Modal E2E test - Email + Passkey');
    ...
    await paraModalExamplePage.login({ context, credential, emailOrPhone, openModalText: OPEN_MODAL_TEXT });
