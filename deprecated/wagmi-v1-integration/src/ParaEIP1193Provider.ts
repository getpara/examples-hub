...
import { getViemChain, createParaViemClient, createParaAccount } from '@getpara/viem-v1-integration';
import ParaWeb, { decimalToHex, hexToDecimal, ParaModalProps } from '@getpara/react-sdk';
...
export class ParaEIP1193Provider extends EventEmitter implements EIP1193Provider {
  ...
  private modalProps: Partial<ParaModalProps>;
