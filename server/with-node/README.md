# Para Server Integration with Node.js

A minimal Node.js example demonstrating Para SDK server-side integration for wallet management and transaction signing with various Web3 libraries and Account Abstraction providers.
