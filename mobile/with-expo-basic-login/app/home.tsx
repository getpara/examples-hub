    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.signCard}>
          <Text style={styles.signHeading}>Sign Message</Text>
          <Pressable
            style={({ pressed }) => [
              styles.signButton,
              (!viemClient || signing) && styles.signButtonDisabled,
              pressed && viemClient && !signing && styles.signButtonPressed,
            ]}
            onPress={handleSign}
          ...
          {signature && (
            <ScrollView horizontal style={styles.signatureContainer}>
