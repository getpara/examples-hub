...
///
/// 1. Wallet connection links (paraflutter://wallet/connect)
/// 2. Custom deep links for app navigation
///
/// Para web-auth callbacks use the same scheme and are handled by
/// flutter_web_auth_2's CallbackActivity on Android.
///
