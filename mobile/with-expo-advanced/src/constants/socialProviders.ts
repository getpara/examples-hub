...
export const PROVIDER_INFO: SocialLoginProvidersMap = {
  ...
  [OAuthMethod.TWITTER]: {
    name: 'Twitter',
    logo: require('../assets/twitter-logo.png'),
  },
  [OAuthMethod.APPLE]: {
    name: 'Apple',
  ...
  [OAuthMethod.DISCORD]: {
    name: 'Discord',
    logo: require('../assets/discord-logo.png'),
  },
...
export const INITIAL_PROVIDERS: OAuthMethod[] = [
  OAuthMethod.GOOGLE,
  OAuthMethod.FACEBOOK,
  OAuthMethod.APPLE,
];
export const ADDITIONAL_PROVIDERS: OAuthMethod[] = [
  OAuthMethod.TWITTER,
  OAuthMethod.DISCORD,
  OAuthMethod.TELEGRAM,
];
