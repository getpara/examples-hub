...
import { TokenAssetListItem, TokenAssetListItemProps } from "@/components/tokens/TokenAssetListItem";
...
export function TokenAssetList({ assets, isLoading, onAssetPress }: AssetSectionProps) {
        ...
        <TabsContent value="assets">
          {assets.length === 0 ? (
            <View className="h-40 items-center justify-center">
              <Text className="text-muted-foreground">{isLoading ? "Loading assets..." : "No assets found"}</Text>
