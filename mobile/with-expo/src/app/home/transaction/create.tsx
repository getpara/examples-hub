...
export default function TransactionCreationScreen() {
  ...
  const _decimals = net === WalletType.EVM ? 18 : 9;
  ...
  const handleContinue = () => {
    ...
    router.navigate({
      ...
      params: {
        ...
        amount: amountInput.amountCrypto,
        usdValue: amountInput.numericUsdValue
          ? amountInput.numericUsdValue.toString()
          : '',
      },
    });
  };
  ...
  return (
    <View className="flex-1 bg-background px-6 pt-6">
      ...
      />
      <AmountField
        value={amountInput.amountCrypto}
        usdValue={amountInput.amountUsd}
      ...
      <Button
        ...
        disabled={!amountInput.isValid || !recipientInput.isValid}
      >
