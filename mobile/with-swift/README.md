Okay, here is the updated README for the Swift example app in Markdown format:
...
2.  **Configure Environment Variables:**
    ...
    *   Under **Environment Variables**, add the following:
    ...
    <img width="800" alt="Xcode Environment Variables" src="https://docs.getpara.com/assets/images/xcode-env-vars-7386511071688f18f01875078592479f.png"> <!-- Updated image link -->
