...
export const Networks = () => {
  ...
  return (
    <ConfigCard
      title="Networks"
      subtitle="Turn on the networks that you would like your app to support. Required networks will ensure that users connect that at least 1 wallet of that type when logging in."
    >
      {form.control && (
        <>
          <FormField
