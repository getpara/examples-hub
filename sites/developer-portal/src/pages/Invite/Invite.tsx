...
export const Invite = ({ isOnboarding }: InviteProps) => {
  ...
  return (
    <div className="para:flex para:flex-col para:justify-center para:w-full para:items-center para:gap-8">
      <div className="para:flex para:flex-col para:justify-center para:w-full para:items-center para:gap-2">
      ...
      <div className="para:flex para:flex-col para:justify-center para:w-full para:items-center para:gap-2">
        ...
        {isOnboarding && (
          <Button className="para:cursor-pointer" variant="link" onClick={handleCreateOrgClick}>
