...
type PortalModalWrapperProps = BasePortalModalWrapperProps & (WithTheme | WithoutTheme);
...
export const PortalModalWrapper = ({
  ...
  return (
    <ChakraProvider theme={theme ?? getPartnerTheme(portalBackgroundColor, portalPrimaryButtonColor, portalTextColor)}>
      <meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no" />
      <Container textColor={portalTextColor} color={portalBackgroundColor} padding={0} minHeight="100%" minWidth="100%">
        <BetaBanner />
