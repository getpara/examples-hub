      ...
      <Row align="center">
        <Col>
          <Text h3 data-testid="session-info-card-text">
            ...
            <Styled.WantsToConnectText>wants to {intention ? intention : 'connect'}</Styled.WantsToConnectText>
          </Text>
        </Col>
      </Row>
      <Row align="center">
        <Col>
          ...
          <Link style={{ verticalAlign: 'middle' }} href={url} data-testid="session-info-card-url">
            <Styled.UrlText>{url}</Styled.UrlText>
          </Link>
        </Col>
      </Row>
        ...
        <StyledUnknownRow>
          <Col style={{ margin: 'auto' }}>
            <Flex justifyContent="center">
              <Styled.CannotVerifyPill>
                <Styled.InfoIcon />
                <Styled.CannotVerifyPillText>Cannot Verify</Styled.CannotVerifyPillText>
              </Styled.CannotVerifyPill>
            </Flex>
          </Col>
        </StyledUnknownRow>
