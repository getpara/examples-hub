...
export class ParaModal {
  ...
  async createUser({
    ...
    if (password) {
      ...
      await this.page.frameLocator('iframe').first().getByRole('textbox', { name: 'Enter password' }).click();
      await this.page.frameLocator('iframe').first().getByRole('textbox', { name: 'Enter password' }).fill(password);
      await this.page.frameLocator('iframe').first().getByRole('textbox', { name: 'Confirm password' }).click();
      await this.page.frameLocator('iframe').first().getByRole('textbox', { name: 'Confirm password' }).fill(password);
      await this.page.frameLocator('iframe').first().getByRole('button', { name: 'Save Password' }).click();
    } else {
  ...
  async login({
    ...
    if (password) {
      ...
      await authPortal.page.getByRole('textbox', { name: 'Enter password' }).click();
      await authPortal.page.getByRole('textbox', { name: 'Enter password' }).fill(password);
